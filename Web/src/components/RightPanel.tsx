...
/// Exported for the public share page, which renders the same per-speaker
/// timeline next to the player. Everything else in this module stays private
/// (it is bound to the local app server).
